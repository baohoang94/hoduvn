    ...
    <div id="signupbox" style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Đăng ký trở thành đối tác của HODU</div>
            ...
            <div class="panel-body" >
                <form action="xulydangky.php" method="post" id="signupform" class="form-horizontal" role="form">  
                    ...
                    <div class="form-group">
                        <label for="fullname" class="col-md-3 control-label">Tên trung tâm</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="fullname" name="fullname" required="required" placeholder="Tên cơ sở đào tạo (*)">
                        </div>
                    </div>
