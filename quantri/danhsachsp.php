<?php
    ...
    // tiếp tục phân trang
    $totalRows = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM sanpham INNER JOIN dmsanpham ON sanpham.id_dm = dmsanpham.id_dm"));
...
<script>
    function xoaSanPham() {
        var conf = confirm('Mi có chắc chắn muốn xóa sản phẩm này ko hả?');
        return conf;
    }
</script>
<div class="row">
